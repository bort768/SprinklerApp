...
namespace Model
{
    public class IrrigationSchedulesSpecificationSearchByDay_TankId_activeScheduleId : BaseSpecifcation<IrrigationSchedule>
    {
    ...
    public class IrrigationSchedulesSpecificationByDay_TankId_Mode : BaseSpecifcation<IrrigationSchedule>
    {
